...
**Exit locked.** You brought enthusiasm. The door requires a patch. Find the mint `+`.

<img src="maps/room-5-1-0.svg" width="400" alt="Maze: you are at column 5, row 1; patch missing." />
...
Coordinates count from the top left, starting at 0. You are at **(5, 1)**.

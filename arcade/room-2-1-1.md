...
<img src="maps/room-2-1-1.svg" width="400" alt="Maze: you are at column 2, row 1; patch equipped." />

| | · wall · | |
| :---: | :---: | :---: |
| [**← LEFT**](room-1-1-1.md) | **● YOU** | [**RIGHT →**](room-3-1-1.md) |
| | · wall · | |

<details>
<summary>Text map / how to play</summary>

Coordinates count from the top left, starting at 0. You are at **(2, 1)**.

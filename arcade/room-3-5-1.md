...
<img src="maps/room-3-5-1.svg" width="400" alt="Maze: you are at column 3, row 5; patch equipped." />

| | [**↑ UP**](room-3-4-1.md) | |
| :---: | :---: | :---: |
| [**← LEFT**](room-2-5-1.md) | **● YOU** | [**RIGHT →**](game-over.md) |
| | · wall · | |

<details>
<summary>Text map / how to play</summary>

Coordinates count from the top left, starting at 0. You are at **(3, 5)**.
